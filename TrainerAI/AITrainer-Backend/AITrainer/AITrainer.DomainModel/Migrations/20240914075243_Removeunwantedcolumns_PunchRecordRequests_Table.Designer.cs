...
namespace AITrainer.Migrations
{
    ...
    [Migration("20240914075243_Removeunwantedcolumns_PunchRecordRequests_Table")]
    partial class Removeunwantedcolumns_PunchRecordRequests_Table
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AITrainer.AITrainer.DomainModel.Models.Admin", b =>
                {
                    ...
                    b.Property<string>("CareerPathId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("AITrainer.AITrainer.DomainModel.Models.BugsFeedback", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.Property<List<string>>("ReportedToId")
                        .HasColumnType("text[]");
            ...
            modelBuilder.Entity("AITrainer.AITrainer.DomainModel.Models.DocumentAttachment", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");

                    b.Property<string>("BugsFeedbackId")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("AITrainer.AITrainer.DomainModel.Models.LeaveDocumentAttachment", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("AITrainer.AITrainer.DomainModel.Models.OverallFeedback", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");

                    b.Property<string>("BehaviourPerformance")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.ToTable("OverallFeedbacks");
                });

            modelBuilder.Entity("AITrainer.AITrainer.DomainModel.Models.PunchLogTime", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.Property<bool>("IsPunchLog")
                        .HasColumnType("boolean");

                    b.Property<bool>("IsPunchLogOut")
                        .HasColumnType("boolean");

                    b.Property<bool>("IsPunchLogin")
                        .HasColumnType("boolean");
                    ...
                    b.Property<string>("PunchRecordId")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.ToTable("PunchLogTimes");
                });

            modelBuilder.Entity("AITrainer.AITrainer.DomainModel.Models.PunchRecord", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("AITrainer.AITrainer.DomainModel.Models.PunchRecordRequests", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("RequestPunches")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("AITrainer.AITrainer.DomainModel.Models.Admin", b =>
                {
                    b.HasOne("AITrainer.AITrainer.DomainModel.Models.CareerPath", "CareerPath")
                        .WithMany()
            ...
            modelBuilder.Entity("AITrainer.AITrainer.DomainModel.Models.DocumentAttachment", b =>
                {
                    b.HasOne("AITrainer.AITrainer.DomainModel.Models.BugsFeedback", "BugsFeedback")
                        .WithMany("Attachments")
                        .HasForeignKey("BugsFeedbackId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BugsFeedback");
                });
            ...
            modelBuilder.Entity("AITrainer.AITrainer.DomainModel.Models.LeaveDocumentAttachment", b =>
                {
                    b.HasOne("AITrainer.AITrainer.DomainModel.Models.LeaveApplication", "leaveApplication")
                        .WithMany("Attachments")
            ...
            modelBuilder.Entity("AITrainer.AITrainer.DomainModel.Models.PunchLogTime", b =>
                {
                    b.HasOne("AITrainer.AITrainer.DomainModel.Models.PunchRecord", "PunchRecord")
                        .WithMany("PunchLogTime")
