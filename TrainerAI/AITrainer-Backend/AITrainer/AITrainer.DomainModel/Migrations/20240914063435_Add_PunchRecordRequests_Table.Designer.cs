...
namespace AITrainer.Migrations
{
    ...
    [Migration("20240914063435_Add_PunchRecordRequests_Table")]
    partial class Add_PunchRecordRequests_Table
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AITrainer.AITrainer.DomainModel.Models.PunchLogTime", b =>
                {
                    ...
                    b.Property<bool>("IsPunchLogRequest")
                        .HasColumnType("boolean");

                    b.Property<DateTime>("PunchIn")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("PunchLogCategory")
                        .HasColumnType("text");
