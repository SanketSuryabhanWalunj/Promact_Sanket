...
const LabResults: React.FC = () => {
  ...
  const dataSourceType = "labresults"; // Fixed for the historical page
  ...
  }, [sortField, sortDirection, searchQuery, dateRange, lakes]);
  return (
    <div>
      ...
      <main>
        <div className="main-page-wrap">
          <div className="historic-container library-table-container">
            <h1 className='mb-2'>{APP_STRINGS.SOURCES_LABRESULTS}</h1>
