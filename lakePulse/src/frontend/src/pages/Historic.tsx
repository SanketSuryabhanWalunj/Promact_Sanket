...
const Historic: React.FC = () => {
  ...
  const dataSourceType = "historical"; // Fixed for the historical page
      ...
      <main>
        <div className="main-page-wrap">
          <div className="historic-container library-table-container">
            <h1 className='mb-2'>{APP_STRINGS.SOURCES_HISTORICREPORTS}</h1>
            ...
            {viewMode === 'list' ? (
              ...
              <div className="grid-view grid grid-cols-4">
                {loading ? (
