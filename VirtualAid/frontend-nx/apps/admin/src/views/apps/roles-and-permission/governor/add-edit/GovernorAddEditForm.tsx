...
interface GovernorAddEditFormType {
  formDefaultValues: GovernorFormType
  onSubmitClick: (data: GovernorFormType, reset?: UseFormReset<GovernorFormType>) => void
  loading: boolean
  errorMsg: string
}

const GovernorAddEditForm = (props: GovernorAddEditFormType) => {
  ...
  const onSubmit = (data: GovernorFormType) => {
...
export default GovernorAddEditForm
